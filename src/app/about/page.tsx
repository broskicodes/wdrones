...
const stages = [
  {
    ...
    content: (
        <div className="w-fit flex flex-col items-center justify-left gap-4">
            ...
            <ul className="list-disc list-inside text-lg md:text-xl max-w-2xl">
  ...
  },
  {
    ...
    content: (
        <div className="w-fit flex flex-col items-center justify-left gap-1">
            <p className="text-lg md:text-xl max-w-2xl w-full">
  ...
  },
  {
    ...
    content: (
        <div className="w-fit flex flex-col items-center justify-left gap-1">
            ...
            <ul className="list-disc list-inside text-lg md:text-xl max-w-2xl pl-4">
            ...
            <ul className="list-disc list-inside text-lg md:text-xl max-w-2xl pl-4 w-full">
